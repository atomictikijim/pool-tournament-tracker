...
public static class HelpContentProvider
{
    ...
    private static HelpDocument TournamentSettings() => new("Tournament Settings Tab — Help", new Builder()
        ...
        .B("Modified Single Elimination requires at least 8 entrants; above that, any count works.")
        ...
        .B("Modified Single Elimination — APA's format; everyone is guaranteed at least two matches. Entrants split into pods of up to 8 that feed a single-elimination final stage. Faster than Double Elimination; any field of 8 or more.")
